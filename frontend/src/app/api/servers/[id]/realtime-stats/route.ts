...
export async function GET(
    ...
    try {
        ...
        const gatewayResponse = await fetch(
            `${GATEWAY_URL}/api/servers/${encodeURIComponent(id)}/realtime-stats?window=${encodeURIComponent(window)}`,
            {
                method: "GET",
        ...
        console.error("Failed to fetch server realtime stats", error);
