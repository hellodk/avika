...
export default function WAFPage() {
    ...
    if (loading) return <div className="flex items-center justify-center h-64 text-white">Loading WAF policies...</div>;
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {policies.length === 0 ? (
                                ...
                                policies.map((policy) => (
                                    <TableRow key={policy.id} className="border-border hover:bg-white/5 transition-colors">
                                        <TableCell>
                    ...
                    <CardContent className="space-y-4">
                        <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20 flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Avika can automatically pull and update the OWASP Core Rule Set (CRS) for enterprise-grade protection.</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
