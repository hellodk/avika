...
const file_agent_proto_rawDesc = "" +
	"\n" +
	"\vagent.proto\x12\x0enginx.agent.v1\"\xc5\x02\n" +
	...
	"\x06agents\x18\x01 \x03(\v2\x19.nginx.agent.v1.AgentInfoR\x06agents\"\xc5\x01\n" +
	"\tAgentInfo\x12\x19\n" +
	...
	"\atraffic\x18\x05 \x01(\tR\atraffic2W\n" +
	"\tCommander\x12J\n" +
	"\aConnect\x12\x1c.nginx.agent.v1.AgentMessage\x1a\x1d.nginx.agent.v1.ServerCommand(\x010\x012\xe9\x05\n" +
	"\fAgentService\x12J\n" +
	...
	"\n" +
	"ListAgents\x12!.nginx.agent.v1.ListAgentsRequest\x1a\".nginx.agent.v1.ListAgentsResponse\x12Q\n" +
	"\x10GetUptimeReports\x12\x1d.nginx.agent.v1.UptimeRequest\x1a\x1e.nginx.agent.v1.UptimeResponse\x12S\n" +
	"\fGetAnalytics\x12 .nginx.agent.v1.AnalyticsRequest\x1a!.nginx.agent.v1.AnalyticsResponseB;Z9github.com/user/nginx-manager/internal/common/proto/agentb\x06proto3"
...
var file_agent_proto_goTypes = []any{
	...
	(*AgentInfo)(nil),            // 25: nginx.agent.v1.AgentInfo
	(*LogRequest)(nil),           // 26: nginx.agent.v1.LogRequest
	(*LogEntry)(nil),             // 27: nginx.agent.v1.LogEntry
	(*UptimeRequest)(nil),        // 28: nginx.agent.v1.UptimeRequest
	(*UptimeResponse)(nil),       // 29: nginx.agent.v1.UptimeResponse
	(*UptimeReport)(nil),         // 30: nginx.agent.v1.UptimeReport
	(*AnalyticsRequest)(nil),     // 31: nginx.agent.v1.AnalyticsRequest
	(*AnalyticsResponse)(nil),    // 32: nginx.agent.v1.AnalyticsResponse
	(*TimeSeriesPoint)(nil),      // 33: nginx.agent.v1.TimeSeriesPoint
	(*StatusCount)(nil),          // 34: nginx.agent.v1.StatusCount
	(*LatencyPercentiles)(nil),   // 35: nginx.agent.v1.LatencyPercentiles
	(*EndpointStat)(nil),         // 36: nginx.agent.v1.EndpointStat
	nil,                          // 37: nginx.agent.v1.ConfigPush.FilesEntry
	nil,                          // 38: nginx.agent.v1.ServerBlock.SslConfigEntry
	nil,                          // 39: nginx.agent.v1.ServerBlock.DirectivesEntry
	nil,                          // 40: nginx.agent.v1.LocationBlock.DirectivesEntry
	nil,                          // 41: nginx.agent.v1.UpstreamBlock.DirectivesEntry
}
var file_agent_proto_depIdxs = []int32{
	...
	27, // 3: nginx.agent.v1.AgentMessage.log_entry:type_name -> nginx.agent.v1.LogEntry
	...
	26, // 6: nginx.agent.v1.ServerCommand.log_request:type_name -> nginx.agent.v1.LogRequest
	3,  // 7: nginx.agent.v1.Heartbeat.instances:type_name -> nginx.agent.v1.NginxInstance
	37, // 8: nginx.agent.v1.ConfigPush.files:type_name -> nginx.agent.v1.ConfigPush.FilesEntry
	...
	38, // 13: nginx.agent.v1.ServerBlock.ssl_config:type_name -> nginx.agent.v1.ServerBlock.SslConfigEntry
	39, // 14: nginx.agent.v1.ServerBlock.directives:type_name -> nginx.agent.v1.ServerBlock.DirectivesEntry
	40, // 15: nginx.agent.v1.LocationBlock.directives:type_name -> nginx.agent.v1.LocationBlock.DirectivesEntry
	41, // 16: nginx.agent.v1.UpstreamBlock.directives:type_name -> nginx.agent.v1.UpstreamBlock.DirectivesEntry
	22, // 17: nginx.agent.v1.CertListResponse.certificates:type_name -> nginx.agent.v1.Certificate
	25, // 18: nginx.agent.v1.ListAgentsResponse.agents:type_name -> nginx.agent.v1.AgentInfo
	30, // 19: nginx.agent.v1.UptimeResponse.reports:type_name -> nginx.agent.v1.UptimeReport
	33, // 20: nginx.agent.v1.AnalyticsResponse.request_rate:type_name -> nginx.agent.v1.TimeSeriesPoint
	34, // 21: nginx.agent.v1.AnalyticsResponse.status_distribution:type_name -> nginx.agent.v1.StatusCount
	35, // 22: nginx.agent.v1.AnalyticsResponse.latency_trend:type_name -> nginx.agent.v1.LatencyPercentiles
	36, // 23: nginx.agent.v1.AnalyticsResponse.top_endpoints:type_name -> nginx.agent.v1.EndpointStat
	0,  // 24: nginx.agent.v1.Commander.Connect:input_type -> nginx.agent.v1.AgentMessage
	8,  // 25: nginx.agent.v1.AgentService.GetConfig:input_type -> nginx.agent.v1.ConfigRequest
	14, // 26: nginx.agent.v1.AgentService.UpdateConfig:input_type -> nginx.agent.v1.ConfigUpdate
	16, // 27: nginx.agent.v1.AgentService.ValidateConfig:input_type -> nginx.agent.v1.ConfigValidation
	18, // 28: nginx.agent.v1.AgentService.ReloadNginx:input_type -> nginx.agent.v1.ReloadRequest
	20, // 29: nginx.agent.v1.AgentService.ListCertificates:input_type -> nginx.agent.v1.CertListRequest
	26, // 30: nginx.agent.v1.AgentService.GetLogs:input_type -> nginx.agent.v1.LogRequest
	23, // 31: nginx.agent.v1.AgentService.ListAgents:input_type -> nginx.agent.v1.ListAgentsRequest
	28, // 32: nginx.agent.v1.AgentService.GetUptimeReports:input_type -> nginx.agent.v1.UptimeRequest
	31, // 33: nginx.agent.v1.AgentService.GetAnalytics:input_type -> nginx.agent.v1.AnalyticsRequest
	1,  // 34: nginx.agent.v1.Commander.Connect:output_type -> nginx.agent.v1.ServerCommand
	9,  // 35: nginx.agent.v1.AgentService.GetConfig:output_type -> nginx.agent.v1.ConfigResponse
	15, // 36: nginx.agent.v1.AgentService.UpdateConfig:output_type -> nginx.agent.v1.ConfigUpdateResponse
	17, // 37: nginx.agent.v1.AgentService.ValidateConfig:output_type -> nginx.agent.v1.ValidationResult
	19, // 38: nginx.agent.v1.AgentService.ReloadNginx:output_type -> nginx.agent.v1.ReloadResponse
	21, // 39: nginx.agent.v1.AgentService.ListCertificates:output_type -> nginx.agent.v1.CertListResponse
	27, // 40: nginx.agent.v1.AgentService.GetLogs:output_type -> nginx.agent.v1.LogEntry
	24, // 41: nginx.agent.v1.AgentService.ListAgents:output_type -> nginx.agent.v1.ListAgentsResponse
	29, // 42: nginx.agent.v1.AgentService.GetUptimeReports:output_type -> nginx.agent.v1.UptimeResponse
	32, // 43: nginx.agent.v1.AgentService.GetAnalytics:output_type -> nginx.agent.v1.AnalyticsResponse
