...
const file_api_proto_agent_proto_rawDesc = "" +
	...
	"\x13requests_per_second\x18\b \x01(\x01R\x11requestsPerSecond\"\xe9\x01\n" +
	...
	"\tlast_seen\x18\b \x01(\x03R\blastSeen\"\x7f\n" +
	"\n" +
	"LogRequest\x12\x1f\n" +
	"\vinstance_id\x18\x01 \x01(\tR\n" +
	"instanceId\x12\x19\n" +
	...
	"\x06follow\x18\x04 \x01(\bR\x06follow\"\xa9\x02\n" +
	"\bLogEntry\x12\x1c\n" +
	...
	"\frequest_time\x18\t \x01(\x02R\vrequestTime\"@\n" +
	...
	"\rtop_endpoints\x18\x04 \x03(\v2\x1c.nginx.agent.v1.EndpointStatR\ftopEndpoints\"Y\n" +
	...
	"\x03p99\x18\x04 \x01(\x02R\x03p99\"\x80\x01\n" +
	...
	"\tCommander\x12J\n" +
	"\aConnect\x12\x1c.nginx.agent.v1.AgentMessage\x1a\x1d.nginx.agent.v1.ServerCommand(\x010\x012\xa6\a\n" +
	"\fAgentService\x12J\n" +
	...
	"\n" +
	"ListAgents\x12!.nginx.agent.v1.ListAgentsRequest\x1a\".nginx.agent.v1.ListAgentsResponse\x12V\n" +
...
var file_api_proto_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_api_proto_agent_proto_goTypes = []any{
	(*AgentMessage)(nil),           // 0: nginx.agent.v1.AgentMessage
	(*NginxMetrics)(nil),           // 1: nginx.agent.v1.NginxMetrics
	(*ServerCommand)(nil),          // 2: nginx.agent.v1.ServerCommand
	(*Heartbeat)(nil),              // 3: nginx.agent.v1.Heartbeat
	(*NginxInstance)(nil),          // 4: nginx.agent.v1.NginxInstance
	(*CommandResult)(nil),          // 5: nginx.agent.v1.CommandResult
	(*StateSnapshot)(nil),          // 6: nginx.agent.v1.StateSnapshot
	(*ConfigPush)(nil),             // 7: nginx.agent.v1.ConfigPush
	(*Action)(nil),                 // 8: nginx.agent.v1.Action
	(*ConfigRequest)(nil),          // 9: nginx.agent.v1.ConfigRequest
	(*ConfigResponse)(nil),         // 10: nginx.agent.v1.ConfigResponse
	(*NginxConfig)(nil),            // 11: nginx.agent.v1.NginxConfig
	(*ServerBlock)(nil),            // 12: nginx.agent.v1.ServerBlock
	(*LocationBlock)(nil),          // 13: nginx.agent.v1.LocationBlock
	(*UpstreamBlock)(nil),          // 14: nginx.agent.v1.UpstreamBlock
	(*ConfigUpdate)(nil),           // 15: nginx.agent.v1.ConfigUpdate
	(*ConfigUpdateResponse)(nil),   // 16: nginx.agent.v1.ConfigUpdateResponse
	(*ConfigValidation)(nil),       // 17: nginx.agent.v1.ConfigValidation
	(*ValidationResult)(nil),       // 18: nginx.agent.v1.ValidationResult
	(*ReloadRequest)(nil),          // 19: nginx.agent.v1.ReloadRequest
	(*ReloadResponse)(nil),         // 20: nginx.agent.v1.ReloadResponse
	(*CertListRequest)(nil),        // 21: nginx.agent.v1.CertListRequest
	(*CertListResponse)(nil),       // 22: nginx.agent.v1.CertListResponse
	(*Certificate)(nil),            // 23: nginx.agent.v1.Certificate
	(*ListAgentsRequest)(nil),      // 24: nginx.agent.v1.ListAgentsRequest
	(*ListAgentsResponse)(nil),     // 25: nginx.agent.v1.ListAgentsResponse
	(*RemoveAgentRequest)(nil),     // 26: nginx.agent.v1.RemoveAgentRequest
	(*RemoveAgentResponse)(nil),    // 27: nginx.agent.v1.RemoveAgentResponse
	(*AgentInfo)(nil),              // 28: nginx.agent.v1.AgentInfo
	(*LogRequest)(nil),             // 29: nginx.agent.v1.LogRequest
	(*LogEntry)(nil),               // 30: nginx.agent.v1.LogEntry
	(*UptimeRequest)(nil),          // 31: nginx.agent.v1.UptimeRequest
	(*UptimeResponse)(nil),         // 32: nginx.agent.v1.UptimeResponse
	(*UptimeReport)(nil),           // 33: nginx.agent.v1.UptimeReport
	(*AnalyticsRequest)(nil),       // 34: nginx.agent.v1.AnalyticsRequest
	(*AnalyticsResponse)(nil),      // 35: nginx.agent.v1.AnalyticsResponse
	(*TimeSeriesPoint)(nil),        // 36: nginx.agent.v1.TimeSeriesPoint
	(*StatusCount)(nil),            // 37: nginx.agent.v1.StatusCount
	(*LatencyPercentiles)(nil),     // 38: nginx.agent.v1.LatencyPercentiles
	(*EndpointStat)(nil),           // 39: nginx.agent.v1.EndpointStat
	(*RecommendationRequest)(nil),  // 40: nginx.agent.v1.RecommendationRequest
	(*RecommendationResponse)(nil), // 41: nginx.agent.v1.RecommendationResponse
	(*Recommendation)(nil),         // 42: nginx.agent.v1.Recommendation
	nil,                            // 43: nginx.agent.v1.ConfigPush.FilesEntry
	nil,                            // 44: nginx.agent.v1.ServerBlock.SslConfigEntry
	nil,                            // 45: nginx.agent.v1.ServerBlock.DirectivesEntry
	nil,                            // 46: nginx.agent.v1.LocationBlock.DirectivesEntry
	nil,                            // 47: nginx.agent.v1.UpstreamBlock.DirectivesEntry
}
var file_api_proto_agent_proto_depIdxs = []int32{
	3,  // 0: nginx.agent.v1.AgentMessage.heartbeat:type_name -> nginx.agent.v1.Heartbeat
	5,  // 1: nginx.agent.v1.AgentMessage.command_result:type_name -> nginx.agent.v1.CommandResult
	6,  // 2: nginx.agent.v1.AgentMessage.state:type_name -> nginx.agent.v1.StateSnapshot
	30, // 3: nginx.agent.v1.AgentMessage.log_entry:type_name -> nginx.agent.v1.LogEntry
	1,  // 4: nginx.agent.v1.AgentMessage.metrics:type_name -> nginx.agent.v1.NginxMetrics
	7,  // 5: nginx.agent.v1.ServerCommand.config_push:type_name -> nginx.agent.v1.ConfigPush
	8,  // 6: nginx.agent.v1.ServerCommand.action:type_name -> nginx.agent.v1.Action
	29, // 7: nginx.agent.v1.ServerCommand.log_request:type_name -> nginx.agent.v1.LogRequest
	4,  // 8: nginx.agent.v1.Heartbeat.instances:type_name -> nginx.agent.v1.NginxInstance
	43, // 9: nginx.agent.v1.ConfigPush.files:type_name -> nginx.agent.v1.ConfigPush.FilesEntry
	11, // 10: nginx.agent.v1.ConfigResponse.config:type_name -> nginx.agent.v1.NginxConfig
	12, // 11: nginx.agent.v1.NginxConfig.servers:type_name -> nginx.agent.v1.ServerBlock
	14, // 12: nginx.agent.v1.NginxConfig.upstreams:type_name -> nginx.agent.v1.UpstreamBlock
	13, // 13: nginx.agent.v1.ServerBlock.locations:type_name -> nginx.agent.v1.LocationBlock
	44, // 14: nginx.agent.v1.ServerBlock.ssl_config:type_name -> nginx.agent.v1.ServerBlock.SslConfigEntry
	45, // 15: nginx.agent.v1.ServerBlock.directives:type_name -> nginx.agent.v1.ServerBlock.DirectivesEntry
	46, // 16: nginx.agent.v1.LocationBlock.directives:type_name -> nginx.agent.v1.LocationBlock.DirectivesEntry
	47, // 17: nginx.agent.v1.UpstreamBlock.directives:type_name -> nginx.agent.v1.UpstreamBlock.DirectivesEntry
	23, // 18: nginx.agent.v1.CertListResponse.certificates:type_name -> nginx.agent.v1.Certificate
	28, // 19: nginx.agent.v1.ListAgentsResponse.agents:type_name -> nginx.agent.v1.AgentInfo
	33, // 20: nginx.agent.v1.UptimeResponse.reports:type_name -> nginx.agent.v1.UptimeReport
	36, // 21: nginx.agent.v1.AnalyticsResponse.request_rate:type_name -> nginx.agent.v1.TimeSeriesPoint
	37, // 22: nginx.agent.v1.AnalyticsResponse.status_distribution:type_name -> nginx.agent.v1.StatusCount
	38, // 23: nginx.agent.v1.AnalyticsResponse.latency_trend:type_name -> nginx.agent.v1.LatencyPercentiles
	39, // 24: nginx.agent.v1.AnalyticsResponse.top_endpoints:type_name -> nginx.agent.v1.EndpointStat
	42, // 25: nginx.agent.v1.RecommendationResponse.recommendations:type_name -> nginx.agent.v1.Recommendation
	0,  // 26: nginx.agent.v1.Commander.Connect:input_type -> nginx.agent.v1.AgentMessage
	9,  // 27: nginx.agent.v1.AgentService.GetConfig:input_type -> nginx.agent.v1.ConfigRequest
	15, // 28: nginx.agent.v1.AgentService.UpdateConfig:input_type -> nginx.agent.v1.ConfigUpdate
	17, // 29: nginx.agent.v1.AgentService.ValidateConfig:input_type -> nginx.agent.v1.ConfigValidation
	19, // 30: nginx.agent.v1.AgentService.ReloadNginx:input_type -> nginx.agent.v1.ReloadRequest
	21, // 31: nginx.agent.v1.AgentService.ListCertificates:input_type -> nginx.agent.v1.CertListRequest
	29, // 32: nginx.agent.v1.AgentService.GetLogs:input_type -> nginx.agent.v1.LogRequest
	24, // 33: nginx.agent.v1.AgentService.ListAgents:input_type -> nginx.agent.v1.ListAgentsRequest
	26, // 34: nginx.agent.v1.AgentService.RemoveAgent:input_type -> nginx.agent.v1.RemoveAgentRequest
	31, // 35: nginx.agent.v1.AgentService.GetUptimeReports:input_type -> nginx.agent.v1.UptimeRequest
	34, // 36: nginx.agent.v1.AgentService.GetAnalytics:input_type -> nginx.agent.v1.AnalyticsRequest
	40, // 37: nginx.agent.v1.AgentService.GetRecommendations:input_type -> nginx.agent.v1.RecommendationRequest
	2,  // 38: nginx.agent.v1.Commander.Connect:output_type -> nginx.agent.v1.ServerCommand
	10, // 39: nginx.agent.v1.AgentService.GetConfig:output_type -> nginx.agent.v1.ConfigResponse
	16, // 40: nginx.agent.v1.AgentService.UpdateConfig:output_type -> nginx.agent.v1.ConfigUpdateResponse
	18, // 41: nginx.agent.v1.AgentService.ValidateConfig:output_type -> nginx.agent.v1.ValidationResult
	20, // 42: nginx.agent.v1.AgentService.ReloadNginx:output_type -> nginx.agent.v1.ReloadResponse
	22, // 43: nginx.agent.v1.AgentService.ListCertificates:output_type -> nginx.agent.v1.CertListResponse
	30, // 44: nginx.agent.v1.AgentService.GetLogs:output_type -> nginx.agent.v1.LogEntry
	25, // 45: nginx.agent.v1.AgentService.ListAgents:output_type -> nginx.agent.v1.ListAgentsResponse
	27, // 46: nginx.agent.v1.AgentService.RemoveAgent:output_type -> nginx.agent.v1.RemoveAgentResponse
	32, // 47: nginx.agent.v1.AgentService.GetUptimeReports:output_type -> nginx.agent.v1.UptimeResponse
	35, // 48: nginx.agent.v1.AgentService.GetAnalytics:output_type -> nginx.agent.v1.AnalyticsResponse
	41, // 49: nginx.agent.v1.AgentService.GetRecommendations:output_type -> nginx.agent.v1.RecommendationResponse
