...
| `TEST_REPORT_2026-02-17.md` | 349 | `TEST_REPORT_2026-03-03.md`, `TEST_SUMMARY_REPORT.md` | Keep latest only; archive older |
...
| Task | Files | Priority | Est. |
|------|-------|----------|------|
| B1. Fix NGINX version detection for K8s agents | [discovery/nginx.go](file:///home/dk/Documents/git/nginx-manager-cursor/cmd/agent/discovery/nginx.go), [metrics/collector.go](file:///home/dk/Documents/git/nginx-manager-cursor/cmd/agent/metrics/collector.go) | P1 | 2h |
| B2. Add component versions to `/health` | [cmd/gateway/main.go](file:///home/dk/Documents/git/nginx-manager-cursor/cmd/gateway/main.go), [cmd/gateway/database.go](file:///home/dk/Documents/git/nginx-manager-cursor/cmd/gateway/database.go) | P2 | 1h |
| B3. Fix binary version via ldflags | `Makefile`, [cmd/agent/main.go](file:///home/dk/Documents/git/nginx-manager-cursor/cmd/agent/main.go) | P2 | 30m |
...
| B5. Suppress Kafka consumer noise | [cmd/gateway/main.go](file:///home/dk/Documents/git/nginx-manager-cursor/cmd/gateway/main.go) | P2 | 1h |
