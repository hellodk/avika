...
- **Running workloads (images)**:
  - **Gateway**: `docker.io/hellodk/avika-gateway:latest` (`Deployment/avika-test-gateway`)
  - **Frontend**: `docker.io/hellodk/avika-frontend:latest` (`Deployment/avika-test-frontend`)
