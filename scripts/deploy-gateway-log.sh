...
# Prerequisite: docker build -t hellodk/avika-gateway:log -f cmd/gateway/Dockerfile . (or make docker-gateway then docker tag)

set -e
IMAGE="${IMAGE:-hellodk/avika-gateway:log}"
