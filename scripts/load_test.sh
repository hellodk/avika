#!/bin/bash
#
# Avika Load Test (unified script)
# Use env: RPS, AGENTS, DURATION, GATEWAY_TARGET. Set SIMPLE=1 for quick run (no harness).
# Full harness: baseline, resource monitor, warmup, cooldown, report.
#
...
REPORT_INTERVAL="${REPORT_INTERVAL:-5s}"
...
TEST_DIR="$RESULTS_DIR/lt_${TIMESTAMP}"
...
echo "╔═══════════════════════════════════════════════════════════════════════════╗"
echo "║                                                                           ║"
echo "║     🚀 AVIKA LOAD TEST: ${TOTAL_RPS} RPS / ${AGENT_COUNT} AGENTS                            ║"
echo "║                                                                           ║"
echo "╠═══════════════════════════════════════════════════════════════════════════╣"
echo "║  Configuration:                                                           ║"
